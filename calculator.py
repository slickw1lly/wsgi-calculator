...
def home(*args):
    """Return body of home page."""

    m = 'http://localhost:8080/multiply/3/5'
    a = 'http://localhost:8080/add/23/42'
    s = 'http://localhost:8080/subtract/23/42'
    d = 'http://localhost:8080/divide/22/11'
...
def resolve_path(path):
    ...
    func_name = path[0]
    args = [float(arg) for arg in path[1:]]
    try:
